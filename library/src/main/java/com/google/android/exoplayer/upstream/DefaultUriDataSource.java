...
public final class DefaultUriDataSource implements UriDataSource {
  ...
  public DefaultUriDataSource(Context context, TransferListener listener, String userAgent,String cookieId) {
    this(context, listener, userAgent, false,cookieId);
  }
  /**
  ...
  public DefaultUriDataSource(Context context, TransferListener listener, String userAgent,
                              boolean allowCrossProtocolRedirects,String cookie) {
    this(context, listener,
            new DefaultHttpDataSource(userAgent, null, listener,
                    DefaultHttpDataSource.DEFAULT_CONNECT_TIMEOUT_MILLIS,
                    DefaultHttpDataSource.DEFAULT_READ_TIMEOUT_MILLIS, allowCrossProtocolRedirects,cookie));
  }
  /**

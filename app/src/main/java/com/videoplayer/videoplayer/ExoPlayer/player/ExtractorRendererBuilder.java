...
public class ExtractorRendererBuilder implements RendererBuilder {
    ...
    private String cookie="unspecified";
    ...
    public ExtractorRendererBuilder(Context context, String userAgent, Uri uri,String cookie) {
        this.context = context;
        this.userAgent = userAgent;
        this.uri = uri;
        this.cookie=cookie;
    ...
    public void buildRenderers(DemoPlayer player) {
        ...
        DefaultBandwidthMeter bandwidthMeter = new DefaultBandwidthMeter(player.getMainHandler(),
                null);
        DataSource dataSource = new DefaultUriDataSource(context, bandwidthMeter, userAgent,cookie);
